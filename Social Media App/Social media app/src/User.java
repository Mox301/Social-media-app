 ...
 */
public class User extends Systems {
	...
	/**
	 * This method will search in the system of the spacific group. If this group found the method will print all informations about
	 * the group else will print *name of group not found in the system*
	 * @param nameOfGroup
	 */
	public void searchForGroup (String nameOfGroup) {
		...
		for(int i = 0; i < super.getAllGroups().size(); i++ ) {
			if(nameOfGroup.equalsIgnoreCase(super.getAllGroups().get(i).getNameOfGroup())) {
				...
				System.out.println("Number of members is " + super.getAllGroups().get(i).getMembers().size());
		...
		if(found == false) {
			System.out.println();
			System.out.println("    *"+ nameOfGroup + " not found in the system*");
			System.out.println();
		}
	}
	
	/**
	 * This method will search in the system of the spacific page. If this page found the method will print all informations about
	 * the page else will print *name of page not found in the system*
	 * @param nameOfGroup
	 */
	public void searchForPage(String nameOfPage) {
		...
		if(found == false) {
			System.out.println();
			System.out.println("    *"+ nameOfPage + " not found system*");
			System.out.println();
		}
	}
	 ...
	 * 
	 * @return privateListMembers - ArrayList contains all close friends.
	 */
	...
	/**
	 * This method will print all message from the spacific user.
	 * 
	 * @param senderEmail
	 */
