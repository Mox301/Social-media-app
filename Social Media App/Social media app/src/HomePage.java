...
/**
 * This is HomePage method, used to visulize all action that can any user do in the social media app.
 * 
 * @author Moemen Mohame
 */

public class HomePage extends Systems {
	private User user;
	...
	/**
	 * This method return the index of User object in the system.
	 * 
	 * @return  index - index of User object in the allUsersDataBase ArrayList in the Systems class
	 */
	...
	/**
	 * This method will print the public informations of User object like (name, number of friends, education and so on...)
	 */
	...
	/**
	 * Setter method for the PhoneNumber if the number is already used in the system the method will print "This phone number is 
	 * already used" else the method will set the new phone number
	 * 
	 * @param phoneNumber
	 */
	...
	/**
	 * Setter method for the email address if the email address is already used in the system the method will print "This email number is 
	 * already used" else the method will set the new email address.
	 * 
	 * @param email
	 */
	...
	/**
	 * This method will check if the email address is already used by the another user or not.
	 * 
	 * @param email
	 * @return flag
	 */
	...
	/**
	 * This method will check if the phone number is already used by the another user or not.
	 * 
	 * @param phoneNumber
	 * @return flag
	 */
	...
	/**
	 * This method method will show the friends posts in the home page. And the user can like and comment in this posts.
	 * 
	...
	public void showFriendsPosts() throws java.lang.IndexOutOfBoundsException {
		...
		for (int i = 0; i < super.getAllUsers().get(getUserIndex()).getFriendsList().size(); i++) {
			for (int j = 0; j < super.getAllUsers().get(getUserIndex()).getUserPosts().size(); j++) {
				...
				// user able to like it's post, comment on it or see the comments on it's post.
	...
	/**
	 * This method method will show the groups posts in the Groups section. And the user can like and comment in this posts.
	 * 
	 * @throws java.lang.IndexOutOfBoundsException
	 */
	...
	/**
	 * This method method will show the pages posts in the pages section. And the user can like and comment in this posts.
	 * 
	 * @throws java.lang.IndexOutOfBoundsException
	 */
	...
	/**
	 * This method will add friend to privateList by taking the first and last name of friend.
	 * 
	 * @param firstName
	 * @param lastName
	 */
	...
	/**
	 * This method will remove friend from privateList by taking the first and last name of friend.
	 * 
	 * @param firstName
	 * @param lastName
	 */
	...
	/**
	 * This method visulize all actions that users can do it like (search, create new post, add friend to private list, chat and so on...)
	 * and also user can go to profile page, Groups section and Pages Section.
	 */
	...
	/**
	 * This method visulize all actions that the user can do it in its profile like (edit your about, sittings and go back to home page)
	 */
	...
	/** 
	 * This method user can edit all its private informations like phone number and email address. and also logout
	 */
	...
	/**
	 * This method will visulize all action that can user do it in the group section.
	 * like create new group, and new post in specific group and so on...
	 */
	public void groupsView() {
		...
		System.out.println("2) Create new post in specific Group. ");
	...
	/**
	 * This method will visulize all action that can user do it in the pages section.
	 * like create new page, and new post in specific page and so on...
	 */
		...
		if(choice.equals("1")) {
			...
			for(int i = 0; i < super.getAllUsers().get(getUserIndex()).getPagesList().size(); i++) {
				if(nameOfPage.equalsIgnoreCase(super.getAllUsers().get(getUserIndex()).getPagesList().get(i).getPageName())) {
					...
					super.getAllUsers().get(getUserIndex()).getPagesList().get(i).addNewPostToPagePostsList(pagePost);
					flag = true;
					break;
				}
			}
	...
	/**
	 * from this method the user can send a message to another user or see the messages from another users.
	 */
